...
var KTDatatablesSearchOptionsAdvancedSearch = function() {
    ...
    var initTable1 = function() {
        ...
        var table = $('#kt_table_1').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '/admin/booking/appointments/get',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'appointmentDate', 'customerName', 'customerEmail', 'customerPhone', 'employeeName',
                        'serviceName', 'serviceDuration', 'servicePrice', 'appointmentstatus', 'Actions',],  _token: $('meta[name="csrf-token"]').attr('content')
                },
            },
            columns: [
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="/admin/booking/appointments/edit/`+full.ID+`"><i class="la la-edit"></i> Edit Details</a>
