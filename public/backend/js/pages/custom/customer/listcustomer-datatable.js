...
var KTAppUserListDatatable = function() {
    ...
    var init = function() {
        ...
        datatable = $('#customersListing').KTDatatable({
            // datasource definition
            data: {
                type: 'remote',
                source: {
                    read: {
                        url: '/admin/customers/customers-detail',
                        method: 'POST',
                        params: {
                ...
                template: function(data, i) {
                   ...
                   // if (number > 5) {
                        output = '<div class="kt-user-card-v2">\
                                ...
                                <a href="/admin/customers/edit/'+data.eid+'" class="kt-user-card-v2__name">' + data.name + '</a>\
                                </div>\
                            </div>';
                   /* } else {
                            ...
                            <div class="dropdown">\
                                ...
                                <div class="dropdown-menu dropdown-menu-right">\
                                    <ul class="kt-nav">\
                                        ...
                                        <li class="kt-nav__item">\
                                            <a href="/admin/customers/edit/'+data.eid+'" class="kt-nav__link">\
