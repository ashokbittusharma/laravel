...
@section('content')
<!-- begin:: Content Head -->
<div class="kt-subheader   kt-grid__item" id="edit-employees-page">
...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
    <div class="kt-wizard-v4" id="edit-an-employee" data-ktwizard-state="step-first">
                        ...
                        <form class="kt-form" id="kt_apps_user_add_user_form">
                           @csrf
                            ...
                            <div class="kt-wizard-v4__content" data-ktwizard-type="step-content" data-ktwizard-state="current">
                                <input type="hidden" name="userid" value=" {{ $getEmpInfo->id }}">
                                                ...
                                                <div class="kt-section__body">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-6">
                                                            <div class="kt-avatar kt-avatar--outline kt-avatar--circle" id="kt_apps_user_add_avatar">
                                                                <div class="kt-avatar__holder" style="overflow: hidden;"><img id="emp_avatar_preview" src="@if ($getEmpInfo->avatar != '') {{asset('backend/media/users/'.$getEmpInfo->avatar)}} @else {{asset('backend/media/users/default.jpg')}} @endif" width="100%" height="100%"></div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control" name="profile_first_name" type="text" value="@if ($getEmpInfo->fname != '') {{$getEmpInfo->fname}} @endif">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Last Name</label>
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input class="form-control" name="profile_last_name" type="text" value="@if ($getEmpInfo->lname != '') {{ $getEmpInfo->lname }} @endif">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <select name="gender" class="form-control" aria-invalid="false">
                                                                ...
                                                                <option value="male" @if ($getEmpInfo->gender == 'male') selected = "selected" @endif>Male</option>
                                                                <option value="female" @if ($getEmpInfo->gender == 'female') selected = "selected" @endif>Female</option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <input id="dob-emp" class="form-control" type="text" readonly="" placeholder="Select date" value="@if ($getEmpInfo->dob != '') {{ $getEmpInfo->dob }} @endif">           
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="profile_phone" class="form-control" value="@if ($getEmpInfo->phone != '') {{ $getEmpInfo->phone }} @endif" placeholder="+15678967456" aria-describedby="basic-addon1">
                                                            </div>                                                            
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" value="@if ($getEmpInfo->email != '') {{ $getEmpInfo->email }} @endif" name="profile_email" placeholder="Email" aria-describedby="basic-addon1">
                                                            </div>
                                                        </div>
                                                    </div> -->
                                                    <div class="form-group form-group-last row">
                                                        ...
                                                        <div class="col-lg-9 col-xl-9">
                                                            <div class="input-group">
                                                                <textarea name="note" class="form-control" id="note" rows="4">@if ($getEmpInfo->note != '') {{ $getEmpInfo->note }} @endif</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
