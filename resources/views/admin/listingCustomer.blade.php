...
@section('content')
<!-- begin:: Content Head -->
                        <div class="kt-subheader   kt-grid__item" id="customerListing">
                            <div class="kt-container  kt-container--fluid ">
                                ...
                                <div class="kt-subheader__toolbar">
                                    ...
                                    <a href="{{ route('add-customers') }}" class="btn btn-label-brand btn-bold">
                                        Add Customer </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                            ...
                            <div class="kt-portlet kt-portlet--mobile">
                                <div class="kt-portlet__body kt-portlet__body--fit">
                                    ...
                                    <!--begin: Datatable -->
                                    <div class="kt-datatable" id="customersListing"></div>
